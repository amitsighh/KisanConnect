...
export const KisanSahayak = () => {
  ...
  const [messages, setMessages] = useState([
    {
      sender: 'assistant',
      text: 'Namaste! Main aapka Kisan Sahayak hoon. KisanConnect platform use karne me main aapki madad kar sakta hoon. Aap mic dabakar bol sakte hain ya neeche type kar sakte hain!',
      timestamp: new Date()
    }
  ]);
